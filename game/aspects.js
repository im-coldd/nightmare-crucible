// aspects.js — full aspect definitions per your doc
export const ASPECTS = {
  ...
  mirror: {
    ...
    desc:'Mirror Aspect: clone and reflection mechanics.',
    tierAbilities: {
  ...
  superhuman: {
    ...
    tierAbilities: {
      ...
      4: { key:'gigantification', name:'Gigantification', desc:'Stomp for 20-35 damage. Essence scaled with damage (example: 20 dmg drains 18 Essence).', cost:18 },
      5: { key:'domain', name:'Domain', desc:'Supreme Domain: 2x damage and -35% incoming for 3 turns. Drains 40 Essence.', cost:40 }
    },
    passiveAbilities: {}
  },
  ...
  seer: {
    ...
    tierAbilities: {
      ...
      4: { key:'memory_implant', name:'Memory Implantation', desc:'26% chance next enemy attack misses (manipulation). Drains 20 Essence.', cost:20 },
      5: { key:'domain', name:'Domain', desc:'Supreme Domain: 2x damage and -35% incoming for 3 turns. Drains 40 Essence.', cost:40 }
    },
    passiveAbilities: {}
  }
